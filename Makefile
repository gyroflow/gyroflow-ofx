...
target/gyroflow-ofx-macosx.dmg: target/x86_64-apple-darwin/release/libgyroflow_ofx.dylib target/aarch64-apple-darwin/release/libgyroflow_ofx.dylib LICENSE README.md target/bundle-common/Info.plist Makefile
	...
	mkdir -p target/gyroflow-ofx-macosx/Gyroflow-old.ofx.bundle/Contents/MacOS

	lipo target/{x86_64,aarch64}-apple-darwin/release/libgyroflow_ofx.dylib -create -output target/gyroflow-ofx-macosx/Gyroflow-old.ofx.bundle/Contents/MacOS/Gyroflow.dylib
